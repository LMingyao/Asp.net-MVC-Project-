...
namespace RentalWebAppR.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApartmentNumber,ApartmentType,Description,Floor,Status,BuildingId")] Apartment apartment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApartmentNumber,ApartmentType,Description,Floor,Status,BuildingId")] Apartment apartment)
        {
            if (ModelState.IsValid)
            {
